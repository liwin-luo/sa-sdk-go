...
func InitDefaultConsumer(url string, timeout int, broker ...string) (*consumers.DefaultConsumer, error) {
	return consumers.InitDefaultConsumer(url, timeout, broker...)
}

func InitBatchConsumer(url string, max, timeout int, broker ...string) (*consumers.BatchConsumer, error) {
	return consumers.InitBatchConsumer(url, max, timeout, broker...)
}
